...
namespace xsd
{
  namespace qif2
  {
    ...
    : ::xml_schema::type (),
      Fonts_ (Fonts, ::xml_schema::flags (), this),
      PMIDisplaySet_ (PMIDisplaySet, ::xml_schema::flags (), this)
    {
    }
    ...
    : ::xml_schema::type (),
      ...
      bold_ (bold_default_value (), ::xml_schema::flags (), this),
      italic_ (italic_default_value (), ::xml_schema::flags (), this),
      underline_ (underline_default_value (), ::xml_schema::flags (), this)
    {
    }
    ...
    PMIDisplaySetType ()
    : ::xml_schema::type (),
      PMIDisplay_ (::xml_schema::flags (), this)
    {
    }
    ...
    : ::xml_schema::type (),
      ...
      Texts_ (::xml_schema::flags (), this),
      Leader_ (::xml_schema::flags (), this),
      WitnessLines_ (::xml_schema::flags (), this),
      Frames_ (::xml_schema::flags (), this),
      Balloon_ (::xml_schema::flags (), this),
           ...
           ::xml_schema::flags f)
    {
      for (; p.more_elements (); p.next_element ())
      {
        ...
        // Leader
        //
        if (n.name () == "Leader" && n.namespace_ () == "http://qifstandards.org/xsd/qif2")
        {
          ::std::auto_ptr< Leader_type > r (
            Leader_traits::create (i, f, this));
    ...
    : ::xsd::qif2::LineSegment2dType (StartPoint,
                                      EndPoint),
      HeadForm_ (HeadForm, ::xml_schema::flags (), this),
      HeadHeight_ (HeadHeight, ::xml_schema::flags (), this)
    {
    }
    ...
    : ::xsd::qif2::LeaderType (StartPoint,
                               ...
                               HeadForm,
                               HeadHeight),
      PointExtension_ (PointExtension, ::xml_schema::flags (), this)
    {
    }
    ...
    : ::xsd::qif2::LeaderType (StartPoint,
                               ...
                               HeadForm,
                               HeadHeight),
      HeadForm2_ (HeadForm2, ::xml_schema::flags (), this),
      PointConnection_ (PointConnection, ::xml_schema::flags (), this)
    {
    }
    ...
    : ::xml_schema::type (),
      ...
      fontIndex_ (fontIndex, ::xml_schema::flags (), this),
      lineHeight_ (::xml_schema::flags (), this),
      N_ (N, ::xml_schema::flags (), this)
    {
    }
           ...
           ::xml_schema::flags f)
    {
      for (; p.more_elements (); p.next_element ())
      {
        ...
        // Frame
        //
        if (n.name () == "Frame" && n.namespace_ () == "http://qifstandards.org/xsd/qif2")
        {
    ...
    : ::xml_schema::type (),
      Segment1_ (Segment1, ::xml_schema::flags (), this),
      Segment2_ (Segment2, ::xml_schema::flags (), this),
    ...
    : ::xsd::qif2::FrameType (XY),
      ...
      crossed_ (crossed_default_value (), ::xml_schema::flags (), this)
    {
    }
    ...
    : ::xml_schema::type (),
      ViewBase_ (::xml_schema::flags (), this),
      N_ (N, ::xml_schema::flags (), this)
    {
    }
           ...
           ::xml_schema::flags f)
    {
      for (; p.more_elements (); p.next_element ())
      {
        ...
        // ViewBase
        //
        if (n.name () == "ViewBase" && n.namespace_ () == "http://qifstandards.org/xsd/qif2")
        {
          ::std::auto_ptr< ViewBase_type > r (
            ViewBase_traits::create (i, f, this));
    ...
    : ::xsd::qif2::ViewBaseType (id),
      ViewPlaneOrigin_ (ViewPlaneOrigin, ::xml_schema::flags (), this),
      Orientation_ (Orientation, ::xml_schema::flags (), this),
      Ratio_ (Ratio, ::xml_schema::flags (), this),
      Near_ (Near, ::xml_schema::flags (), this),
      Far_ (Far, ::xml_schema::flags (), this),
      Height_ (Height, ::xml_schema::flags (), this)
    {
    }
    ...
    : ::xsd::qif2::CameraBaseType (id,
                                   ...
                                   Far,
                                   Height),
      AnnotationVisibleIds_ (::xml_schema::flags (), this),
      AnnotationHiddenIds_ (::xml_schema::flags (), this),
      BodyIds_ (::xml_schema::flags (), this),
      ComponentIds_ (::xml_schema::flags (), this),
      PlaneClippingIds_ (::xml_schema::flags (), this)
    {
    }
    ...
    SavedViewType (const ::xercesc::DOMElement& e,
                   ...
                   ::xml_schema::container* c)
    : ::xsd::qif2::CameraBaseType (e, f | ::xml_schema::flags::base, c),
      AnnotationVisibleIds_ (f, this),
      AnnotationHiddenIds_ (f, this),
      BodyIds_ (f, this),
      ComponentIds_ (f, this),
      PlaneClippingIds_ (f, this)
    {
      if ((f & ::xml_schema::flags::base) == 0)
      {
        ::xsd::cxx::xml::dom::parser< char > p (e, true, true);
...
namespace xsd
{
  namespace qif2
  {
           ...
           const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::FrameType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::FrameType, char >::create (
            e, f, 0));
        return r;
      }
                      ...
                      const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::FrameRectangularType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::FrameRectangularType, char >::create (
            e, f, 0));
        return r;
      }
                   ...
                   const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::FrameCircularType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::FrameCircularType, char >::create (
            e, f, 0));
        return r;
      }
               ...
               const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::FrameFlagType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::FrameFlagType, char >::create (
            e, f, 0));
        return r;
      }
                        ...
                        const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::FrameIrregularFormType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::FrameIrregularFormType, char >::create (
            e, f, 0));
        return r;
      }
            ...
            const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::LeaderType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::LeaderType, char >::create (
            e, f, 0));
        return r;
      }
                  ...
                  const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::LeaderExtendType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::LeaderExtendType, char >::create (
            e, f, 0));
        return r;
      }
                    ...
                    const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::LeaderCircularType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::LeaderCircularType, char >::create (
            e, f, 0));
        return r;
      }
                      ...
                      const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::LeaderDoubleHeadType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::LeaderDoubleHeadType, char >::create (
            e, f, 0));
        return r;
      }
                              ...
                              const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::LeaderDoubleHeadCircularType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::LeaderDoubleHeadCircularType, char >::create (
            e, f, 0));
        return r;
      }
                            ...
                            const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::LeaderDoubleHeadExtendType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::LeaderDoubleHeadExtendType, char >::create (
            e, f, 0));
        return r;
      }
              ...
              const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::ViewBaseType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::ViewBaseType, char >::create (
            e, f, 0));
        return r;
      }
            ...
            const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::CameraType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::CameraType, char >::create (
            e, f, 0));
        return r;
      }
               ...
               const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::SavedViewType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::SavedViewType, char >::create (
            e, f, 0));
        return r;
      }
