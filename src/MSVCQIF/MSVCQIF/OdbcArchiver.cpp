...
public:
	...
	SQLHANDLE _hEnv ;
	SQLHANDLE _hStmt ;
	HRESULT OpenSqlDatabase(std::string dbname="QIF");
...
HRESULT OdbcWindows::Check( SQLRETURN rc, char * msg, bool throwFailedExpection, bool printSucceededMsg )
{
	if( SQL_SUCCEEDED( rc ) )
	{
