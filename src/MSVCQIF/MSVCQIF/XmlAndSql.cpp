...
{
#if 0
	else if(_stricmp(type.c_str(), "anySimpleType") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "anyURI") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "language") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "string") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "normalizedString") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "token") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "NMTOKEN") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "QPIdType") == 0)  tmp="text";

#endif
	// FIXME: lots of these data types are unused. And if used would be used incorrectly.
	std::string tmp;
	if(_stricmp(type.c_str(), "int") == 0) return val;
	else if(_stricmp(type.c_str(), "integer") == 0) return val;
	else if(_stricmp(type.c_str(), "unsignedShort") == 0)  return val;
	else if(_stricmp(type.c_str(), "nonNegativeInteger") == 0) return val;
	else if(_stricmp(type.c_str(), "long") == 0) return val;
	else if(_stricmp(type.c_str(), "negativeInteger") == 0)  return val;
	else if(_stricmp(type.c_str(), "nonNegativeInteger") == 0) return val;
	else if(_stricmp(type.c_str(), "nonPositiveInteger") == 0)  return val;
	else if(_stricmp(type.c_str(), "positiveInteger") == 0)  return val;
	else if(_stricmp(type.c_str(), "NonNegativeDecimalType") == 0)  return val;
	else if(_stricmp(type.c_str(), "ParameterRangeType") == 0)  return val;
	else if(_stricmp(type.c_str(), "ListNaturalType") == 0) return val;
	else if(_stricmp(type.c_str(), "ListUnsignedByteType") == 0)  return val;
	else if(_stricmp(type.c_str(), "ColorType") == 0)  return val;
	else if(_stricmp(type.c_str(), "ListAccumulatedStatsValuesType") == 0)  return val;
	else if(_stricmp(type.c_str(), "ListSubgroupStatsValuesType") == 0) return val;
	else if(_stricmp(type.c_str(), "ListDouble9Type") == 0)  return val;
	else if(_stricmp(type.c_str(), "D4Type") == 0)  return val;
	else if(_stricmp(type.c_str(), "ListSummaryStatsValuesType") == 0) return val;
	else if(_stricmp(type.c_str(), "PositiveDecimalType") == 0) return val;

	else if(_stricmp(type.c_str(), "ListIntType") == 0)  return val;
	else if(_stricmp(type.c_str(), "I2Type") == 0)  return val;
	else if(_stricmp(type.c_str(), "ListDoubleType") == 0)  return val;
	else if(_stricmp(type.c_str(), "D3Type") == 0)  return val;
	else if(_stricmp(type.c_str(), "D2Type") == 0)  return val;
	else if(_stricmp(type.c_str(), "Point2dSimpleType") == 0)  return val;
	else if(_stricmp(type.c_str(), "UnitVector2dSimpleType") == 0)  return val;
	else if(_stricmp(type.c_str(), "PointSimpleType") == 0) return val;
	else if(_stricmp(type.c_str(), "VectorSimpleType") == 0)  return val;
	else if(_stricmp(type.c_str(), "UnitVectorSimpleType") == 0)  return val;
	else if(_stricmp(type.c_str(), "NaturalType") == 0)  return val;
	else if(_stricmp(type.c_str(), "QIFIdType") == 0)  return val;

	else if(_stricmp(type.c_str(), "anySimpleType") == 0) return val;

	else if(_stricmp(type.c_str(), "base64Binary") == 0)  return val; // tmp="text";
	else if(_stricmp(type.c_str(), "boolean") == 0)  return val;
	else if(_stricmp(type.c_str(), "byte") == 0) return val;
	else if(_stricmp(type.c_str(), "decimal") == 0)  return val;
	else if(_stricmp(type.c_str(), "double") == 0)  return val;
	else if(_stricmp(type.c_str(), "DoublePositiveType") == 0)  return val;
	else if(_stricmp(type.c_str(), "duration") == 0)  return val;
	else if(_stricmp(type.c_str(), "float") == 0)  return val;
	else if(_stricmp(type.c_str(), "gDay") == 0)  return val;
	else if(_stricmp(type.c_str(), "gMonth") == 0)  return val;
	else if(_stricmp(type.c_str(), "gMonthDay") == 0)  return val;
	else if(_stricmp(type.c_str(), "gYear") == 0)  return val;
	else if(_stricmp(type.c_str(), "gYearMonth") == 0)  return val;
	else if(_stricmp(type.c_str(), "hexBinary") == 0)  return val;
	else if(_stricmp(type.c_str(), "short") == 0)   return val;
	else if(_stricmp(type.c_str(), "unsignedByte") == 0)   return val;
	else if(_stricmp(type.c_str(), "unsignedInt") == 0)  return val;
	else if(_stricmp(type.c_str(), "unsignedLong") == 0)   return val;
	else if(_stricmp(type.c_str(), "unsignedShort") == 0)   return val;

	else if(_stricmp(type.c_str(), "QPIdType") == 0)  return  StrFormat("'%s'", val.c_str()); // uuid  now in quotes
	else if(_stricmp(type.c_str(), "QPIdReferenceType") == 0)  return  StrFormat("'%s'", val.c_str()); // uuid  now in quotes

	else if(_stricmp(type.c_str(), "NMTOKEN") == 0)  return StrFormat("'%s'", val.c_str());
	else if(_stricmp(type.c_str(), "language") == 0)  return StrFormat("'%s'", val.c_str());
	else if(_stricmp(type.c_str(), "token") == 0)  return StrFormat("'%s'", val.c_str());
	else if(_stricmp(type.c_str(), "string") == 0)   return StrFormat("'%s'", val.c_str());
	else if(_stricmp(type.c_str(), "normalizedString") == 0)   return StrFormat("'%s'", val.c_str());
	...
	//	else if(_stricmp(type.c_str(), "dateTime") == 0)  tmp="TIMESTAMP";
	else if(_stricmp(type.c_str(), "time") == 0)  return StrFormat("'%s'", val.c_str());
	else if(_stricmp(type.c_str(), "date") == 0)  return StrFormat("'%s'", val.c_str());
	else if(_stricmp(type.c_str(), "dateTime") == 0)
	{
		ReplaceAll(val,"T", " ");
		return StrFormat("'%s'", val.c_str());
	}
...
{
	std::string tmp;
	if(_stricmp(type.c_str(), "int") == 0) tmp="integer";
	else if(_stricmp(type.c_str(), "anySimpleType") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "anyURI") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "base64Binary") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "boolean") == 0)  tmp="BOOLEAN";
	else if(_stricmp(type.c_str(), "byte") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "ColorType") == 0)  tmp="integer[]";
	else if(_stricmp(type.c_str(), "D2Type") == 0)  tmp="FLOAT[2]";
	else if(_stricmp(type.c_str(), "D3Type") == 0)  tmp="FLOAT[3]";
	else if(_stricmp(type.c_str(), "D4Type") == 0)  tmp="FLOAT[4]";
	else if(_stricmp(type.c_str(), "date") == 0)  tmp="DATE";
	else if(_stricmp(type.c_str(), "dateTime") == 0)  tmp="TIMESTAMP";
	else if(_stricmp(type.c_str(), "decimal") == 0)  tmp="DECIMAL(10,2)";
	else if(_stricmp(type.c_str(), "double") == 0)  tmp="DOUBLE PRECISION";
	else if(_stricmp(type.c_str(), "DoublePositiveType") == 0)  tmp="DOUBLE PRECISION";
	else if(_stricmp(type.c_str(), "duration") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "float") == 0)  tmp="FLOAT";
	else if(_stricmp(type.c_str(), "gDay") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "gMonth") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "gMonthDay") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "gYear") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "gYearMonth") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "hexBinary") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "I2Type") == 0)  tmp="integer[2]";
	else if(_stricmp(type.c_str(), "integer") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "language") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "ListAccumulatedStatsValuesType") == 0)  tmp="integer[]";
	else if(_stricmp(type.c_str(), "ListDouble9Type") == 0)  tmp="FLOAT[]";
	else if(_stricmp(type.c_str(), "ListDoubleType") == 0)  tmp="FLOAT[]";
	else if(_stricmp(type.c_str(), "ListIntType") == 0)  tmp="integer[]";
	else if(_stricmp(type.c_str(), "ListNaturalType") == 0)  tmp="FLOAT[]";
	else if(_stricmp(type.c_str(), "ListSubgroupStatsValuesType") == 0)  tmp="integer[]";
	else if(_stricmp(type.c_str(), "ListSummaryStatsValuesType") == 0)  tmp="integer[]";
	else if(_stricmp(type.c_str(), "ListUnsignedByteType") == 0)  tmp="integer[]";
	else if(_stricmp(type.c_str(), "long") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "NaturalType") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "negativeInteger") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "NMTOKEN") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "NonNegativeDecimalType") == 0)  tmp="DECIMAL(10,2)";
	else if(_stricmp(type.c_str(), "nonNegativeInteger") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "nonNegativeInteger") == 0) tmp="integer";
	else if(_stricmp(type.c_str(), "nonPositiveInteger") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "normalizedString") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "ParameterRangeType") == 0)  tmp="FLOAT[2]";
	else if(_stricmp(type.c_str(), "Point2dSimpleType") == 0)  tmp="FLOAT[2]";
	else if(_stricmp(type.c_str(), "PointSimpleType") == 0)  tmp="FLOAT[3]";
	else if(_stricmp(type.c_str(), "PositiveDecimalType") == 0)  tmp="DECIMAL(10,2)";
	else if(_stricmp(type.c_str(), "positiveInteger") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "QIFIdType") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "QPIdReferenceType") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "QPIdType") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "short") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "string") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "time") == 0)  tmp="TIME";
	else if(_stricmp(type.c_str(), "token") == 0)  tmp="text";
	else if(_stricmp(type.c_str(), "UnitVector2dSimpleType") == 0)  tmp="FLOAT[2]";
	else if(_stricmp(type.c_str(), "UnitVectorSimpleType") == 0)  tmp="FLOAT[3]";
	else if(_stricmp(type.c_str(), "unsignedByte") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "unsignedInt") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "unsignedLong") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "unsignedShort") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "unsignedShort") == 0)  tmp="integer";
	else if(_stricmp(type.c_str(), "VectorSimpleType") == 0)  tmp="FLOAT[3]";
...
void CXmlAndSql::CreateSqlTableFromType(IXmlNodePtr def, std::string &sql, std::string constraints,std::string &keys)
{
	...
	else if(stricmp(name.c_str(),"any")==0)
	{ 
		//_asm int 3;
...
void CXmlAndSql::ParseQifDocument(xercesc::DOMElement* e,  std::string & sql, std::string outertypename)
{
	...
	if(nodeType ==  DOMNode::ELEMENT_NODE)
	{
		...
		for(ChildMapIterator it=_childrenmap.begin(); it!= _childrenmap.end(); it++)
		{
			...
			if(varentity==NULL && _symbols.IsSubstitutionGroupElement(childname))
