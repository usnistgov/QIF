...
namespace xsd
{
  namespace qif2
  {
    ...
    : ::xsd::qif2::DrawableBaseType (id),
      CoordinateSystemCore_ (CoordinateSystemCore, ::xml_schema::flags (), this)
    {
    }
    ...
    : ::xml_schema::type (),
      Auxiliary_ (::xml_schema::flags (), this),
      N_ (N, ::xml_schema::flags (), this)
    {
    }
           ...
           ::xml_schema::flags f)
    {
      for (; p.more_elements (); p.next_element ())
      {
        ...
        // Auxiliary
        //
        if (n.name () == "Auxiliary" && n.namespace_ () == "http://qifstandards.org/xsd/qif2")
        {
          ::std::auto_ptr< Auxiliary_type > r (
            Auxiliary_traits::create (i, f, this));
    ...
    : ::xsd::qif2::AuxiliaryBaseType (id),
      Plane_ (Plane, ::xml_schema::flags (), this)
    {
    }
    ...
    : ::xsd::qif2::AuxiliaryPlaneBaseType (id,
      ...
      enable_ (enable_default_value (), ::xml_schema::flags (), this)
    {
    }
...
namespace xsd
{
  namespace qif2
  {
               ...
               const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::AuxiliaryBaseType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::AuxiliaryBaseType, char >::create (
            e, f, 0));
        return r;
      }
                    ...
                    const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::PointAuxiliaryType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::PointAuxiliaryType, char >::create (
            e, f, 0));
        return r;
      }
                   ...
                   const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::LineAuxiliaryType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::LineAuxiliaryType, char >::create (
            e, f, 0));
        return r;
      }
                    ...
                    const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::PlaneReferenceType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::PlaneReferenceType, char >::create (
            e, f, 0));
        return r;
      }
                   ...
                   const ::xml_schema::properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::xsd::qif2::PlaneClippingType > r (
          ::xsd::cxx::tree::traits< ::xsd::qif2::PlaneClippingType, char >::create (
            e, f, 0));
        return r;
      }
